...
document.querySelector('.js-validation-age-fields').addEventListener('input', function (e) {
  this.value = this.value.replace(/[^0-9\+$]/, '');
});
document.querySelector('.js-validation-phone-fields').addEventListener('input', function (e) {
  this.value = this.value.replace(/[^\d.]/, '');
});
document.querySelector('.js-validation-name-fields').addEventListener('input', function (e) {
